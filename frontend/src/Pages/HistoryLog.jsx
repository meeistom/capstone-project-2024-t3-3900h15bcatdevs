    ...
    axios
      ...
      .then((entries) => {
        entries.forEach((entry) => {
          const motherUrl = `${URL}/mothers?mrn=${entry.owner_mrn}`;
          axios
            .get(motherUrl)
            .then((motherResponse) => {
            ...
            .catch((error) => {
              console.error(
                `Error fetching mother details for MRN ${entry.owner_mrn}:`,
                error
              );
            });
        });
